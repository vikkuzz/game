...
// Отталкивание только на очень близкой дистанции (меньше минимальной дистанции атаки)
// Это предотвращает "дрейф" сражающихся юнитов
const MIN_DISTANCE = 20; // Минимальное расстояние между юнитами (меньше дистанции атаки 35px)
const SEPARATION_SPEED = 110; // Скорость отталкивания (пикселей в секунду)
